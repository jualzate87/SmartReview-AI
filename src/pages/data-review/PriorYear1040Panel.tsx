...
import img1040Prior from '../../assets/1040-2024-preview.png'
...
const PRIOR_YEAR_FIELDS: { line: string; label: string; amount: string; bold?: boolean; section?: string }[] = [
  ...
  { line: '1z',  label: 'Add lines 1a–1h',                          amount: '105,000' },
  { line: '2b',  label: 'Taxable interest',                          amount: '1,400'   },
  { line: '3a',  label: 'Qualified dividends',                       amount: '—'       },
  { line: '3b',  label: 'Ordinary dividends',                        amount: '500'     },
  { line: '7',   label: 'Capital gain or (loss)',                    amount: '2,500'   },
  { line: '9',   label: 'Total income',                              amount: '109,400', bold: true },
  { section: 'ADJUSTMENTS TO INCOME' },
  { line: '11',  label: 'Adjusted gross income',                     amount: '109,400', bold: true },
  { section: 'DEDUCTIONS' },
  { line: '12',  label: 'Standard deduction',                        amount: '13,850'  },
  { line: '15',  label: 'Taxable income',                            amount: '95,550',  bold: true },
  { section: 'TAX AND CREDITS' },
  { line: '16',  label: 'Tax (see instructions)',                    amount: '16,734'  },
  { line: '24',  label: 'Total tax',                                 amount: '16,734',  bold: true },
  { section: 'PAYMENTS' },
  { line: '25a', label: 'Federal income tax withheld (W-2)',         amount: '15,987'  },
  { line: '33',  label: 'Total payments',                            amount: '15,987',  bold: true },
  { line: '37',  label: 'Amount you owe',                            amount: '747'     },
]
  ...
  return (
    <div ref={containerRef} className={styles.container}>
      ...
      <div className={styles.docSection} style={{ height: `${docHeightPct}%` }}>
        ...
        >
          <div style={{ position: 'relative', width: `${zoom}%`, lineHeight: 0, flexShrink: 0 }}>
            <img src={img1040Prior} alt="Prior Year Form 1040 (2024)" className={docStyles.documentImage} draggable={false} />
          </div>
        </div>
      ...
      <div className={styles.fieldsSection}>
        ...
        <div className={styles.subHeader}>Jordan Wells · 111-11-1111</div>
